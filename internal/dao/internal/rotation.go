...
// RotationDao is the data access object for table gf_rotation.
...
// RotationColumns defines and stores column names for table gf_rotation.
...
// rotationColumns holds the columns for table gf_rotation.
